    ...
    return Scaffold(
      ...
      body: FutureBuilder<List<Contact>>(
        ...
        future: Future.delayed(Duration(seconds: 1))
            .then((value) => _repository.findAll()),
      ...
      child: InkWell(
        onTap: () {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => TransactionForm(_contact)),
          );
        },
        child: Card(
          child: ListTile(
